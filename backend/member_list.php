<?php
      include('h.php');
                ...
                $query = "SELECT * FROM tbl_member " or die("Error:" . mysqli_error());
                ...
                echo ' <table class="table table-hover">';
                  ...
                  echo "<tr>";
                    ...
                    //แก้ไขข้อมูล
                    // หน้าแก้ไขข้อมูล User
                    echo "<td><a href='member_from_edit.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs'>แก้ไข</a></td> ";  
                    //ลบข้อมูล
