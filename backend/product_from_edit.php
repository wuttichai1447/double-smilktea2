...
<div class="container">
  <div class="row">
      <form  name="add product" action="product_from_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            ...
            <button type="submit" class="btn btn-success" name="btn add"> บันทึก </button>
